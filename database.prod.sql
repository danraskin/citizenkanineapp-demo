...
insert into ck_prod.employees_schedule
...
CREATE TABLE ck_prod.employees_schedule_changes (
	"id" SERIAL PRIMARY KEY,
	"emp_id" INT NOT NULL,   --REFERENCES ck_demoprod.clients(id) ON DELETE CASCADE--
...
insert into ck_prod.clients_schedule
	("client_id", "1", "2", "3", "4", "5") 
values
...
CREATE TABLE ck_prod.daily_dogs (
	...
	"route_id" INT NOT NULL REFERENCES ck_prod.routes(id),
	"client_id" INT NOT NULL REFERENCES ck_prod.clients(id),
...
insert into ck_prod.daily_dogs
...
INSERT INTO ck_prod.admin_notes
	("user_id", "notes")
VALUES
